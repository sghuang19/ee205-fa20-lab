apos_k=[sin(pi/2)/pi,sin(pi)/(2*pi),sin(pi*3/2)/(3*pi),sin(2*pi)/(4*pi),sin(pi*5/2)/(5*pi)];
aneg_k=[sin(-pi/2)/(-pi),sin(-pi)/(-2*pi),sin(-pi*3/2)/(-3*pi),sin(-2*pi)/(-4*pi),sin(-pi*5/2)/(-5*pi)];
