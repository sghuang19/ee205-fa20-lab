...
The plots of $x_11[n]$, h1[n] and h2[n] are shown below.
<!-- TODO: Mathjax -->
...
To finds out the two outputs, we should first figure out the output of system 1, which is `(n + 1) .* x1[n]`. Then we use the output as the input of System 2, and use $h_{f2}[n]$ as the impulse response to get the output $y_{f1}[n]$.
...
![Figure 2.4 b](https://raw.githubusercontent.com/SamuelHuang2019/SigSys-lab/master/figures/A2_2-4_g.png)
