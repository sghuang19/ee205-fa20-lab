...
Comparing this plot with the plots for frequency response, we can find that frequency components for system2 will amplify $x[n]$ while system1 will attenuate it.
