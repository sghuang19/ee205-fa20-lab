...
The period of $y[n]$ should also be $N_y = 2N - 1$. In each shift, there should be $i$ times of multiplication and $i - 1$ times of addition, hence the total number of operations is
